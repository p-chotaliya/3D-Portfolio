  ...
  export const myProjects = [
    {
      ...
      texture: '/3D-Portfolio/textures/project/fileshare.mp4',
      logo: '/3D-Portfolio/assets/fileShareLogo.png',
      logoStyle: {
      ...
      tags: [
        {
          id: 1,
          name: 'Angular.js',
          path: '/3D-Portfolio/assets/Angular.svg',
        },
        {
          id: 2,
          name: 'TailwindCSS',
          path: '/3D-Portfolio/assets/tailwindcss.png',
        },
        {
          id: 3,
          name: 'TypeScript',
          path: '/3D-Portfolio/assets/typescript.png',
        },
        {
          id: 4,
          name: 'Express JS',
          path: '/3D-Portfolio/assets/Express.svg',
        },
      ],
    },
    {
      ...
      logo: '/3D-Portfolio/assets/Analysis.png',
      logoStyle: {
      ...
      tags: [
        ...
        },
        {
          id: 2,
          name: 'Material UI',
          path: '/3D-Portfolio/assets/Mui.svg',
        },
        {
          id: 3,
          name: 'TypeScript',
    ...
    },
    {
      ...
      texture: '/3D-Portfolio/textures/project/AR-APP.mp4',
      ...
      tags: [
        {
          id: 1,
          name: 'Python',
          path: '/3D-Portfolio/assets/python.png',
        },
      ],
    },
    {
      ...
      texture: '/3D-Portfolio/textures/project/Ecommerce.mp4',
      logo: '/3D-Portfolio/assets/Ecommerce.png',
      logoStyle: {
      ...
      tags: [
        {
          id: 1,
          name: 'React.js',
          path: '/3D-Portfolio/assets/react.svg',
        },
        {
          id: 2,
          name: 'TailwindCSS',
        ...
        },
        {
          id: 4,
          name: 'Node JS',
          path: '/3D-Portfolio/assets/Nodejs.svg',
        },
        {
          id: 5,
          name: 'Notion ',
          path: '/3D-Portfolio/assets/notion.svg',
        },
      ],
    },
  ...
  export const workExperiences = [
    {
      ...
      icon: '/3D-Portfolio/assets/Arolytics.png',
      animation: 'victory',
    },
    {
      id: 2,
      ...
      icon: '/3D-Portfolio/assets/Digimaze.png',
      animation: 'clapping',
    },
    {
      id: 3,
      ...
      icon: '/3D-Portfolio/assets/Infosys.png',
      animation: 'salute',
    },
  ];